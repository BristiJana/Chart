### On opening the given link of Repository you all will see a a green code option in top right of repository click it and copy the HTTP link given (https://github.com/BristiJana/Chart.git).
